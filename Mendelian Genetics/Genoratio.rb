#It gives the ratios of two,four and six genotype
def GenotypeRatio(a,b,c = "R")

  genotype_1 = a.to_s
  typ = c
  return "Enter R or T" unless typ == "R" or typ == "T"
  ...
  num = fook.values.each.map{|ef|ef.quo(4)}  #Numbers generated
  ...
  puts real.to_h
      ...
      geno_2 = genotype_2.chars
      geno.count.times{|k| geno_2.count.times{|v|ratio << geno[k] + geno_2[v]}}
      ratio.each.map{|z|z.chars.sort.join}.tally
      end
    ...
    fook = ratio_3.tally
    num = fook.values.each.map{|ef|ef.quo(16)}  #Numbers generated
    num_2 = fook.keys #Keys generated
    realratio = [] << num_2 << num
    real = realratio.transpose
    puts real.to_h
    ...
    fook = ratio_5.tally
    num = fook.values.each.map{|ef|ef.quo(64)}  #Numbers generated
    num_2 = fook.keys #Keys generated
    realratio = [] << num_2 << num
    real = realratio.transpose
    puts real.to_h
