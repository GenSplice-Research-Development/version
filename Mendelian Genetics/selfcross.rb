def SelfCross(a)
  alleles = a
  if alleles.size == 2
    seq = alleles.chars.map{|e|e.to_sym} #Creates an Array and converts each member to a symbol
    seq1= alleles.chars.map{|e|e.to_sym} #Creates an Array and converts each member to a symbol
